...
export default function Accordion(){
    ...
    return(
        <>
            ...
            >
                Nama "Almaty" berasal dari kata <span lang="kk-KZ">aлмa</span>, dalam bahasa Kazakh yang berarti "apel" dan sering diterjemahkan sebagai "penuh dengan apel". Sebenarnya, wilayah sekitar Almaty dipercaya sebagai asal usul apel, dan <i lang="la">Malus sieversii</i> liar dianggap sebagai kandidat
